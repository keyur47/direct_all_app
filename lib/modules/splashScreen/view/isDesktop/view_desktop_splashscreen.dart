...
class ViewDesktopSplashScreen extends StatelessWidget {
  const ViewDesktopSplashScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Stack(
      ...
      children: [
        ...
        Padding(
          padding:  EdgeInsets.only(bottom: SizeUtils.horizontalBlockSize * 1),
          child:  SizedBox(
